...
slate.create = function(data) {
	...
	{type:"document", id: 0, seed:0, nodes:[], length:1} : data;
}
...
slate.apply = function(doc, ops) {
	...
	for (var i = 0; i < ops.length; i++) {
		...
		if (typeof op === 'number') {
			...
			//delete
			//TODO: check remove actually matches
